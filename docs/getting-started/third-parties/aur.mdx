...
not persistent by default. Use the first-run transport choice for [built-in
HTTPS](/using-seerr/advanced/built-in-tls), an HTTPS reverse proxy, or explicitly
acknowledge and enable the trusted-LAN HTTP fallback.
:::
