...
const LanguagePicker = () => {
  ...
  return (
    <div className="relative">
      <div>
        <button
          className={`rounded-full p-1 hover:bg-gray-600 hover:text-white focus:bg-gray-600 focus:text-white focus:ring-1 focus:ring-gray-500 focus:outline-none sm:p-2 ${
